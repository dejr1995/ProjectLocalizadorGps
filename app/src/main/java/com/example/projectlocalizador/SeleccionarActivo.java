...
public class SeleccionarActivo extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private class Getfrutas extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(SeleccionarActivo.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String json = jsonParser.makeServiceCall(URL_LISTA_1, ServiceHandler.GET);
